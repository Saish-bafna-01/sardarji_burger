export default function ContactHero({
  ...
  return (
    <section
      className="relative w-full lg:mt-24 min-h-[400px] sm:min-h-[400px] md:min-h-[450px] lg:min-h-[500px] flex items-center justify-left bg-linear-to-b from-black via-black/60 to-transparent bg-cover bg-center pt-24 md:pt-28"
    ...
    >
      ...
      {/* Content — centered */}
      <div className="w-[900px] relative z-10 flex flex-col gap-3 md:gap-4 px-4 sm:px-6 py-12 sm:py-16 md:py-20 lg:py-24">
        {/* Heading */}
