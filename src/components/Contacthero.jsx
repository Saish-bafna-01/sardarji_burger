export default function ContactHero({
  ...
  return (
    <section
      className="relative w-full min-h-[400px] sm:min-h-[400px] md:min-h-[450px] lg:min-h-[500px] flex items-center justify-left bg-linear-to-b from-black via-black/60 to-transparent bg-cover bg-center"
