...
import momChuri from "../assets/images/Be-be’s Churi Desi Ghee & Gur.png";
...
import kalDosa from "../assets/images/kaldosa.png";
import idly from "../assets/images/idli sambar.png";
import minidosa from "../assets/images/Mini Dosa.png";
import longdosa from "../assets/images/long_dosa.png";
import punjabiDosa from "../assets/images/punjabi_dosa.png";
import chesse_dosa from "../assets/images/chesse_dosa.png";
import cone_dosa from "../assets/images/cone_dosa.png";
import cheese_cone_dosa from "../assets/images/cheese_cone_dosa.png";
import Masala_Uttapam from "../assets/images/Masala_Uttapam.png";
...
import Gobhi_Manchurian from "../assets/images/Gobhi_Manchurian.png";
import Chilli_Paneer_Dry from "../assets/images/Chilli Paneer Dry.png";
import tawa_pizza from "../assets/images/tawa_pizza.png";
import vegetableNoodle from "../assets/images/veg_Noodles.png";
import springRolls from "../assets/images/spring_roll.png";
...
export const menuPageData = {
  "Most Popular": [
    ...
    { id: 4, name: "2 pc Samosa Plate", desc: "2 pc Samosa with Chana & Sauce", price: "$7.99", img: samosa },
  ...
  "Dosas & Idly": [
    // Punjabi & Special Dosas
    { id: 1, name: "Desi Ghee Punjabi Dosa", desc: "Punjabi style crispy dosa with desi ghee", price: "$12.99", img: punjabiDosa },
    ...
    { id: 5, name: "Masala Dosa", desc: "Crispy dosa with potato filling", price: "$12.99", img: masalaDosa },
    { id: 6, name: "Paneer Masala Dosa", desc: "Dosa filled with spiced paneer", price: "$12.99", img: paneerTikkaDosa },
    { id: 7, name: "Cheese Masala Dosa", desc: "Dosa with cheese filling", price: "$12.99", img: chesse_dosa },
    { id: 8, name: "Cheese Dosa", desc: "Crispy dosa with melted cheese", price: "$12.99", img: chesse_dosa },
    { id: 9, name: "Onion Masala Dosa", desc: "Dosa with onion topping", price: "$12.99", img: masalaDosa },
    // Classic Dosas
    { id: 10, name: "Ghee Roast Dosa", desc: "Crispy dosa roasted in pure ghee", price: "$12.99", img: gheeDosa },
    { id: 11, name: "Kal Dosa", desc: "Soft fluffy melt in the mouth", price: "$12.99", img: kalDosa },
    { id: 12, name: "Plain Dosa", desc: "Crispy plain dosa", price: "$12.99", img: masalaDosa },
    // Kids & Family
    { id: 13, name: "Mini Dosa (5 pcs)", desc: "Kid-friendly mini dosas", price: "$12.99", img: minidosa },
    { id: 14, name: "Family Dosa (4 ft)", desc: "Giant 4 feet dosa for sharing", price: "$24.99", img: longdosa },
    { id: 15, name: "Cone Dosa (Kids Only)", desc: "Fun cone shaped dosa for kids", price: "$6.99", img: cone_dosa },
    { id: 16, name: "Cheese Cone Dosa (Kids Only)", desc: "Cone dosa with cheese for kids", price: "$7.99", img: cheese_cone_dosa },
    // Uttapam & Idly
    { id: 17, name: "Masala Uttapam", desc: "Thick savory pancake with toppings", price: "$12.99", img: Masala_Uttapam },
    { id: 18, name: "Idly (4 pcs)", desc: "Steamed rice cakes with sambar & chutney", price: "$10.99", img: idly },
    { id: 19, name: "Sambar Idly", desc: "Idly served in sambar", price: "$10.99", img: methuVada },
  ],
  "Burgers & Snacks": [
    ...
    { id: 6, name: "Gobhi Manchurian", desc: "Crispy cauliflower in manchurian sauce", price: "$10.99", img: Gobhi_Manchurian },
    { id: 7, name: "Chilli Paneer Dry", desc: "Spicy dry paneer starter", price: "$12.99", img: Chilli_Paneer_Dry },
    { id: 8, name: "Veg Tawa Pizza", desc: "Vegetable pizza on tawa", price: "$12.99", img: tawa_pizza },
    { id: 9, name: "Vegetable Noodle", desc: "Stir fried vegetable noodles", price: "$7.99", img: vegetableNoodle },
    { id: 10, name: "Spring Rolls (8 pcs)", desc: "Crispy vegetable spring rolls", price: "$6.99", img: springRolls },
    { id: 11, name: "Fries", desc: "Crispy golden french fries", price: "$4.99", img: fries },
  ],
  "Samosa": [
    { id: 1, name: "Veg Samosa (1 pc)", desc: "Crispy vegetable samosa", price: "$1.99", img: samosa },
    { id: 2, name: "Veg Samosa (10 pcs)", desc: "Crispy vegetable samosas", price: "$15.00", img: samosa },
    { id: 3, name: "Above 10 Samosas", desc: "$1.50 each", price: "$1.50", img: samosa },
    { id: 4, name: "2 pc Samosa Plate", desc: "Samosa with Chana & Sauce", price: "$7.99", img: samosa },
  ],
};
...
// Customer Reviews (4+ Star Reviews from Google/Uber Eats)
export const customerReviews = [
  {
    id: 1,
    name: "Michelle B.",
    rating: 5,
    review: "The flavours remind me of Carla's cooking at Mudpot years ago. Delicious as usual.",
    source: "Google",
  },
  {
    id: 2,
    name: "Mohini T.",
    rating: 5,
    review: "They were very accommodating with my dietary restrictions. Great quality, great taste - I'd definitely recommend this place.",
    source: "Uber Eats",
  },
  {
    id: 3,
    name: "Sasi K.",
    rating: 5,
    review: "Chicken65 and egg kothu parotta… Tasty is amazing and it's very delicious. ⭐️10/10",
    source: "Google",
  },
  {
    id: 4,
    name: "Sunil J.",
    rating: 5,
    review: "Real taste of Kerala food.",
    source: "Google",
  },
  {
    id: 5,
    name: "Syed J.",
    rating: 5,
    review: "Excellent food and best quality keep it up thanks.",
    source: "Google",
  },
  {
    id: 6,
    name: "Soby S.",
    rating: 5,
    review: "Authentic South Indian food!!!",
    source: "Google",
  },
  {
    id: 7,
    name: "Maulik D.",
    rating: 5,
    review: "EXTRAORDINARY AND VERY DELICIOUS PEPPER CHICKEN",
    source: "Uber Eats",
  },
  {
    id: 8,
    name: "Matbarsingh N.",
    rating: 5,
    review: "Tasty south Indian food. First time we ordered from here and loved it. Will order again for sure.",
    source: "Uber Eats",
  },
  {
    id: 9,
    name: "Ankita K.",
    rating: 5,
    review: "I ordered mysore masala dosa, it's tasty and full flavour of South India.",
    source: "Uber Eats",
  },
  {
    id: 10,
    name: "Pavan M.",
    rating: 5,
    review: "I have really liked the food, it's so tasty!",
    source: "Uber Eats",
  },
  {
    id: 11,
    name: "Komal N.",
    rating: 5,
    review: "Nice food and nice packaging.",
    source: "Uber Eats",
  },
  {
    id: 12,
...
// Images needed (set to null in menuData)
// Add these images to src/assets/images/ folder:
// - Desi Ghee Punjabi Dosa.png
// - Cheese Masala Dosa.png
// - Cheese Dosa.png
// - Mini Dosa.png
// - Family Dosa.png
// - Cone Dosa.png
// - Cheese Cone Dosa.png
// - Masala Uttapam.png
// - Gobhi Manchurian.png
// - Chilli Paneer Dry.png
// - Veg Tawa Pizza.png
// - Vegetable Noodle.png
// - Spring Rolls.png
// - Fries.png